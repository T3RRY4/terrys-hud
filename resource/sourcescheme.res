...
Scheme
{
	Colors
	{
		...
		"G_InctiveWindow"			"30 30 30 245" // Inactive window bg color
		"G_TitleBg"					"255 255 255 255" // Title bg color
		"G_TitleText"				"30 30 30 255" // Title text color
		...
		"G_SelectedText"			"30 30 30 255" // Selected text color
		"G_DisabledText"			"220 206 199 150" // Disabled text color
		"G_ButtonBg"				"20 20 20 255" // Button bg color
	...
	Fonts
	{
		...
		AchievementItemTitle	[$WIN32]
		{
			"1"
			{
				...
				"name"		"AvenirLTStd-Medium Bold" [$OSX]
				"weight"		"1500"
				"tall"			"16" [!$OSX]
				"tall"			"18" [$OSX]
				"antialias"		"1"
